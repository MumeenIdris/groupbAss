...
$name= $_GET['id'];
$drugQuery="SELECT d.name, e.id FROM drugs AS e JOIN manufacturer as d on e.manufacturer_id =d.id WHERE e.name='" . $name ."'";
...
echo json_encode(array('manufacturer' => $drugData, ));
